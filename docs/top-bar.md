...
- align top-bar behavior with the always-visible radio-side information defined in `docs/use-cases.md`
- keep placement compatible with the stick monitor and card layout defined in `docs/stick-monitor.md` and `docs/telemetry-layout.md`
